...
## Project Structure
    ...
    ├── screen_only_templat_36793  # Django project configurations
...
1. Clone this repo and `cd screen_only_templat_36793`
...
2. Clone this repo and `cd screen_only_templat_36793`
